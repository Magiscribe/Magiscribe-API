...
export type CapabilityResolvers<ContextType = any, ParentType extends ResolversParentTypes['Capability'] = ResolversParentTypes['Capability']> = {
  ...
  prompts?: Resolver<Maybe<Array<Maybe<ResolversTypes['Prompt']>>>, ParentType, ContextType>;
  subscriptionFilter?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type FrameResolvers<ContextType = any, ParentType extends ResolversParentTypes['Frame'] = ResolversParentTypes['Frame']> = {
  _id?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  childElements?: Resolver<Array<ResolversTypes['Element']>, ParentType, ContextType>;
  childFrames?: Resolver<Array<ResolversTypes['Frame']>, ParentType, ContextType>;
...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  addChildElements?: Resolver<Maybe<ResolversTypes['Frame']>, ParentType, ContextType, RequireFields<MutationAddChildElementsArgs, 'childElementIds' | 'frameId'>>;
  addChildFrames?: Resolver<Maybe<ResolversTypes['Frame']>, ParentType, ContextType, RequireFields<MutationAddChildFramesArgs, 'childFrameIds' | 'frameId'>>;
  ...
  addUpdateAgent?: Resolver<Maybe<ResolversTypes['Agent']>, ParentType, ContextType, RequireFields<MutationAddUpdateAgentArgs, 'agent'>>;
  addUpdateCapability?: Resolver<Maybe<ResolversTypes['Capability']>, ParentType, ContextType, RequireFields<MutationAddUpdateCapabilityArgs, 'capability'>>;
  addUpdatePrompt?: Resolver<Maybe<ResolversTypes['Prompt']>, ParentType, ContextType, RequireFields<MutationAddUpdatePromptArgs, 'prompt'>>;
  createElement?: Resolver<Maybe<ResolversTypes['Element']>, ParentType, ContextType, RequireFields<MutationCreateElementArgs, 'element'>>;
  createFrame?: Resolver<Maybe<ResolversTypes['Frame']>, ParentType, ContextType, RequireFields<MutationCreateFrameArgs, 'frame'>>;
  createUpdateDataObject?: Resolver<ResolversTypes['DataObject'], ParentType, ContextType, RequireFields<MutationCreateUpdateDataObjectArgs, 'data'>>;
  ...
  deleteElement?: Resolver<Maybe<ResolversTypes['Element']>, ParentType, ContextType, RequireFields<MutationDeleteElementArgs, 'elementId'>>;
  deleteFrame?: Resolver<Maybe<ResolversTypes['Frame']>, ParentType, ContextType, RequireFields<MutationDeleteFrameArgs, 'frameId'>>;
  ...
  generateTranscriptionStreamingCredentials?: Resolver<Maybe<ResolversTypes['TemporaryCredentials']>, ParentType, ContextType>;
  insertIntoDataObject?: Resolver<ResolversTypes['DataObject'], ParentType, ContextType, RequireFields<MutationInsertIntoDataObjectArgs, 'field' | 'id' | 'value'>>;
  updateElement?: Resolver<Maybe<ResolversTypes['Element']>, ParentType, ContextType, RequireFields<MutationUpdateElementArgs, 'element' | 'elementId'>>;
  updateFrame?: Resolver<Maybe<ResolversTypes['Frame']>, ParentType, ContextType, RequireFields<MutationUpdateFrameArgs, 'frame' | 'frameId'>>;
};
...
export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  ...
  getElement?: Resolver<Maybe<ResolversTypes['Element']>, ParentType, ContextType, RequireFields<QueryGetElementArgs, 'elementId'>>;
  getFrame?: Resolver<Maybe<ResolversTypes['Frame']>, ParentType, ContextType, RequireFields<QueryGetFrameArgs, 'frameId'>>;
  getPrompt?: Resolver<Maybe<ResolversTypes['Prompt']>, ParentType, ContextType, RequireFields<QueryGetPromptArgs, 'promptId'>>;
  userForms?: Resolver<Array<ResolversTypes['DataObject']>, ParentType, ContextType, RequireFields<QueryUserFormsArgs, 'userId'>>;
};
...
export type TemporaryCredentialsResolvers<ContextType = any, ParentType extends ResolversParentTypes['TemporaryCredentials'] = ResolversParentTypes['TemporaryCredentials']> = {
