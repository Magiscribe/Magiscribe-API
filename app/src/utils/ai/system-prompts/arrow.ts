...
def generate_coordinateDict(startX, startY, xMin, xMax, yMin, yMax, graphScaleX, graphScaleY, x1, y1, x2, y2):
  ...
  coordinateDict = {
    "elementProperties": {"type": "arrow", "endArrowhead": "arrow", "startArrowhead": "arrow"}, #ALWAYS include endArrowhead, ONLY include startArrowhead if the user directly requests a bidirectional arrow
