...
selectedAgents can ONLY be one of the following: lineAgent, functionAgent, textAgent, rectangleAgent, ellipseAgent, diamondAgent, or pointAgent. Do NOT include any other agents.
lineAgent draws lines, functionAgent draws functions, textAgent writes alphanumeric text with known characters, rectangleAgent draws rectangles, ellipseAgent draws ellipses and circles, diamondAgent draws diamonds, pointAgent draws points
