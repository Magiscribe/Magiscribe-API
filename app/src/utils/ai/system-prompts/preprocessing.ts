...
selectedAgents can ONLY be one of the following: lineAgent, functionAgent, textAgent, rectangleAgent, ellipseAgent, diamondAgent, arrowAgent, or pointAgent. Do NOT include any other agents.
