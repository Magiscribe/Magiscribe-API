...
This JSON also contains a textResponse which is a succinct description of what this is for accessibility purposes when line, freedraw, ellipse, or rectangle is the object to be rendered for text object type
 
Example coordinateDict Structure:
{
    "elementProperties": {
      "type": "freedraw" | "line" | "text" | "rectangle" | "ellipse", #required
    ...
    "relativeCoordinates": [number, number][], #required for freedraw and line and rectangle and ellipse
