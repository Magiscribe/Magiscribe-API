...
This JSON also contains a textResponse which is a succinct description of what this is for accessibility purposes when line or freedraw, is the object to be rendered for text object type
 
Example coordinateDict Structure:
{
    "elementProperties": {
      "type": "freedraw" | "line" | "text", #required
    ...
    "relativeCoordinates": [number, number][], #required for freedraw and line
