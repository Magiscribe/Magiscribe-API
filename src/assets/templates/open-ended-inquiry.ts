        ...
        conditions: [
          {
            to: 'eh4e',
            condition:
              'If the user makes a statement that warrants a follow up question OR if the "Bot" has the most recent message in the conversation',
          },
          {
            to: 'h7eu',
            condition:
              'If the user asked us a question that warrants a direct response',
          },
          {
            to: 't9ki',
