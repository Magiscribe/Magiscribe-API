...
export const sendInquiryToUsers = async ({
  userData,
  inquiryId,
}: {
  ...
  await sendEmail({
    ...
    templateData: {
      ...
      content: [
        ...
        `<br />`,
        `<br />`,
        `Magiscribe helps you create dynamic conversations and gather meaningful insights from your audience so that teams can spend more time doing what matters.`,
        `Our AI-powered inquiry system guarantees key questions get asked to everyone and dynamically generates follow-up questions.`,
